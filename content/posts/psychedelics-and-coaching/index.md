...
tags: ["post","coaching","psychedelics"]
#externalUrl: ""
#showSummary: true
...
I beleive that Solution Focused approaches are idea for psychedelic experiencers, as they move the person from the past to the preferred future. Furthermore the model presumes that the client has the skills and resources necessary to make the changes they wish to see. This avoids pathologising the client. In short Solution Focused approaches consider the client to be the expert in their own lives and able to make change.
